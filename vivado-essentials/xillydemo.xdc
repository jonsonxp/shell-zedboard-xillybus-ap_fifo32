...
# clk_out-frequency: 1-100MHz, 2-150MHz, 3-200MHz
set_false_path -from [get_clocks clk_fpga_1] -to [get_clocks clk_out1_clk_wiz_0]; #progma_clk_shell_to_ip
set_false_path -from [get_clocks clk_out1_clk_wiz_0] -to [get_clocks clk_fpga_1]; #progma_clk_ip_to_shell
